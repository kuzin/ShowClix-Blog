...
<?php /* How to display all other posts. */ ?>
    ...
    <?php else : ?>
        ...
        <div id="featured-image" style="width:660px;"><a href="<?php the_permalink(); ?>#wrapper" title="<?php printf( esc_attr__( 'Permalink to %s', 'starkers' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><img style="width: 100%" src="<?php echo $image[0]; ?>" alt="feature-image-<?=$post->ID?>"/></a></div>
        ...
        <?php endif; ?>
			...
			<header>
                <h1><a href="<?php the_permalink(); ?>#wrapper" title="<?php printf( esc_attr__( 'Permalink to %s', 'starkers' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
